...
METADATA_DIRECTORY: str = os.path.normpath(os.path.join(os.path.dirname(__file__), "..", "data", "index", "shortened_metadata.csv"))
NEW_METADATA_DIRECTORY: str = os.path.normpath(os.path.join(os.path.dirname(__file__), "..", "data", "index", "temporary_metadata.csv"))
...
metadata: pd.DataFrame = process_in_parallel(metadata)

metadata.to_csv(NEW_METADATA_DIRECTORY)
